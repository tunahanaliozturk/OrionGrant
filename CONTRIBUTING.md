# Contributing to OrionGrant

Thanks for taking the time to look at this. Permission and policy authorization for .NET: hierarchical colon-scoped permissions with wildcard matching, role expansion, and all-of / any-of access policies. The project is small and the bar for contributions is "does it make the package clearer, faster, or safer without expanding the public surface needlessly."
...
```bash
git clone https://github.com/tunahanaliozturk/OrionGrant
cd OrionGrant
dotnet restore
